package qzhenghao.cn.i_today.beans;
 ...
 *
 */
public class MainDataItemBean implements Parcelable {
    ...
    public MainDataItemBean(JSONObject jsonObject) {
    ...
    protected MainDataItemBean(Parcel in) {
        title = in.readString();
        image = in.readString();
        id = in.readLong();
    ...
    public static final Creator<MainDataItemBean> CREATOR = new Creator<MainDataItemBean>() {
        @Override
        public MainDataItemBean createFromParcel(Parcel in) {
            return new MainDataItemBean(in);
        }

        @Override
        public MainDataItemBean[] newArray(int size) {
            return new MainDataItemBean[size];
        }
    };
