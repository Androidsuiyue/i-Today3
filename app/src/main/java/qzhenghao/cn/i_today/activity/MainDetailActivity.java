...
import qzhenghao.cn.i_today.adapter.MainDetailAdapter;
...
import qzhenghao.cn.i_today.utils.FitScreenUtil;
...
import qzhenghao.cn.i_today.widget.media.IjkVideoView;
...
public class MainDetailActivity extends BaseActivity {
    ...
    private  MainDataItemBean mainItemBean;
    private long id;
    private int page = 0;
